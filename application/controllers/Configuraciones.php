...
class Configuraciones extends CI_Controller
{
  ...
  public function index($msj=0)
  {
    ...
    // $data['mitiketera']=$this->consultas->getTiketera();
    $data['impresoras']=$this->consultas->getTabla("tb_impresoras");
  ...
  public function addImpresora()
  {
    ...
    $data = array('impresora' => $impresora );
    $this->insertar->insertarGral("tb_impresoras",$data);
  }
