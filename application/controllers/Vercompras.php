...
class Vercompras extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $ventas = $this->consultas->getComprasReporte();
    $data['ventas']=$ventas;
    ...
    $this->load->view('vercompras',$data);
  ...
  public function resultado()
  {
    ...
    $ventasPeriodo = $this->consultas->getComprasPeriodo(1,$fecha1,$fecha2);
    ...
    $dataSidebar['classCompras']="";
    $dataSidebar['classRepCompras']="";
