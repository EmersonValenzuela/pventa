    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Impresora</h3>
            <div class="pull-right box-tools">
              <button type="button" class="btn btn-primary btn-sm" id="btnNuevaImpresora" data-toggle="tooltip" title="Agregar nueva impresora" data-original-title="Agregar nueva impresora">
                <i class="fa fa-print" aria-hidden="true"></i> Nueva
              </button>
            </div>
          </div>
          <div class="box-body box-profile">
            <!-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5 -->
            <table id="tbImpresoras" class="table table-striped table-bordered dt-responsive nowrap table-hover table-condensed" cellspacing="0" width="100%" style="background: white!important">
              <thead>
                <tr>
                  <th class="bg-primary"><span>&nbsp;</span></th>
                  <th class="bg-primary"><span>Impresora</span></th>
                </tr>
              </thead>
              <tbody>
                <?php
                foreach ($impresoras as $impresora) {
                  ?>
                  <tr>
                    <td class="text-center"><i class="fa fa-print" aria-hidden="true"></i></td>
                    <td class="text-left"><?=$impresora['impresora']?></td>
                </tr>
              <?php } ?>
            </tbody>
          </table>
